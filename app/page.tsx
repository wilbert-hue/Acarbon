  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Global Spectral Sensors Market'}
              </h2>
            </div>
          </div>
        ...
        <div className="mb-6 flex items-start gap-2 px-4 py-3 bg-amber-50 border border-amber-300 rounded-lg text-amber-800 text-sm">
